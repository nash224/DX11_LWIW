...
void UI_ProductPage::CreatePage(std::string_view _ProduectName, int& PageCount)
{
	...
	CompositionPosition = { -176.0f , 129.0f , GlobalUtils::CalculateFixDepth(EUI_RENDERORDERDEPTH::Attachment) };
	...
	CompositionPosition = { -176.0f , 25.0f , GlobalUtils::CalculateFixDepth(EUI_RENDERORDERDEPTH::Attachment) };
	...
	CompositionPosition = { -176.0f , 25.0f , GlobalUtils::CalculateFixDepth(EUI_RENDERORDERDEPTH::Component) };
	...
	CompositionPosition = { -176.0f , -46.0f , GlobalUtils::CalculateFixDepth(EUI_RENDERORDERDEPTH::Frame) };
	...
	CompositionPosition = { 79.0f , 129.0f  , GlobalUtils::CalculateFixDepth(EUI_RENDERORDERDEPTH::Component) };
	...
	CompositionPosition = { 79.0f + CONST_OptionGap , 129.0f , GlobalUtils::CalculateFixDepth(EUI_RENDERORDERDEPTH::Component) };
	...
	CompositionPosition = { 79.0f + CONST_OptionGap * 2.0f, 129.0f , GlobalUtils::CalculateFixDepth(EUI_RENDERORDERDEPTH::Component) };
	...
	CompositionPosition = { 79.0f , 45.0f , GlobalUtils::CalculateFixDepth(EUI_RENDERORDERDEPTH::Attachment) };
	...
	CompositionPosition = { 79.0f , 45.0f  , GlobalUtils::CalculateFixDepth(EUI_RENDERORDERDEPTH::Component) };
	...
	CompositionPosition = { 79.0f , 45.0f - CONST_ItemSpaceGap  , GlobalUtils::CalculateFixDepth(EUI_RENDERORDERDEPTH::Attachment) };
	...
	if ("" != Data->Material[2].MaterialName)
	{
		...
		CompositionPosition = { 79.0f , 45.0f - CONST_ItemSpaceGap * 2.0f , GlobalUtils::CalculateFixDepth(EUI_RENDERORDERDEPTH::Attachment) };
		...
		CompositionPosition = { 79.0f , 45.0f - CONST_ItemSpaceGap * 2.0f , GlobalUtils::CalculateFixDepth(EUI_RENDERORDERDEPTH::Component) };
