...
void LoadingLevel::LoadContentsData()
{
	...
	// 물약
	ProductRecipeData::CreateData("BadGrassPotion", {"BadGrassPotion", "나쁜 풀 제거 물약", ESTARTYPE::Easy, ELADLETYPE::None, EFIRETYPE::Four, "Mongsiri_Water", 2, "WitchFlower_Water", 2});
	ProductRecipeData::CreateData("NutritionPotion", {"NutritionPotion", "풀 성장 물약", ESTARTYPE::Normal, ELADLETYPE::StirRight, EFIRETYPE::Three, "SilverStarFlower_Water", 2, "MapleHerb_Water", 2, "BushBug_Water", 2});
	ProductRecipeData::CreateData("FirecrackerPotion", { "FirecrackerPotion", "불꽃놀이 물약", ESTARTYPE::Hard, ELADLETYPE::StirRight, EFIRETYPE::Three, "PumpkinTerrier_Powder", 2, "FlowerBird_Water", 2, "MoonButterfly_Water", 2 });

	// 사탕
	ProductRecipeData::CreateData("UncurseCandy", {"UncurseCandy", "단풍 허브", ESTARTYPE::Easy, ELADLETYPE::None, EFIRETYPE::Three, "Mongsiri_Water", 2, "MapleHerb_Water", 2});
	ProductRecipeData::CreateData("HealingCandy", {"HealingCandy", "치료 사탕", ESTARTYPE::Easy, ELADLETYPE::StirRight, EFIRETYPE::Four, "WitchFlower_Water", 2, "MapleHerb_Water", 2});
}
