...
{
	ItemInfo::CreateData({"Mongsiri", "몽시리", "몽시리털", ETOOLTYPE::Gloves, EECOLOGYTYPE::GreenForest ,EECOLOGYTYPE::ForestPlains, EECOLOGYTYPE::Day});
	ItemInfo::CreateData({"PumpkinTerrier", "호박 강아지", "호박 강아지의 털 조각", ETOOLTYPE::Gloves, EECOLOGYTYPE::GreenForest, EECOLOGYTYPE::ForestPlains, EECOLOGYTYPE::AllDay});
	ItemInfo::CreateData({"BushBug", "덤불 깨비", "덤불 깨비", ETOOLTYPE::FeaturePan, EECOLOGYTYPE::GreenForest, EECOLOGYTYPE::None, EECOLOGYTYPE::AllDay });
	ItemInfo::CreateData({"FlowerBird", "새싹새", "새꽃", ETOOLTYPE::Gloves, EECOLOGYTYPE::GreenForest, EECOLOGYTYPE::ForestPlateau, EECOLOGYTYPE::Day});
	ItemInfo::CreateData({"BubbleLizard", "푸른 방울 도마뱀", "웃음방울", ETOOLTYPE::Gloves, EECOLOGYTYPE::GreenForest, EECOLOGYTYPE::ForestWaterfall, EECOLOGYTYPE::Day});


	ItemInfo::CreateData({ "WitchFlower", "마녀꽃", "마녀꽃 뿌리", ETOOLTYPE::Gloves, EECOLOGYTYPE::GreenForest, EECOLOGYTYPE::None, EECOLOGYTYPE::AllDay });
	ItemInfo::CreateData({ "SilverStarFlower", "은별방울꽃", "은별방울꽃 가루", ETOOLTYPE::Dragonfly, EECOLOGYTYPE::GreenForest, EECOLOGYTYPE::ForestWaterfall, EECOLOGYTYPE::Night });
	ItemInfo::CreateData({"MapleHerb", "단풍 허브", "단풍 허브", ETOOLTYPE::Gloves, EECOLOGYTYPE::GreenForest, EECOLOGYTYPE::ForestPlateau, EECOLOGYTYPE::AllDay});
}
