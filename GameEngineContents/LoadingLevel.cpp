...
void LoadingLevel::LoadTexture()
{
	...
	{
		// 플레이 액터
		GlobalUtils::LoadAllDirFile("Resources\\PlayContents\\PlayResourecs\\Creature");	// 크리처
		GlobalUtils::LoadAllDirFile("Resources\\PlayContents\\PlayResourecs\\Map");			// 맵
		GlobalUtils::LoadAllFileInPath("Resources\\PlayContents\\PlayResourecs\\Ellie");	// 앨리
		GlobalUtils::LoadAllFileInPath("Resources\\PlayContents\\PlayResourecs\\Ellie\\Broom");	// 빗자루
