...
void UI_BiologyPage::CreatePage(std::string_view _BiologyName, int& PageCount)
{
	...
	m_BiologyPageComposition.Photo = CreateComponent<GameEngineUIRenderer>(EUI_RENDERORDERORDER::Attachment);
	...
	m_BiologyPageComposition.Frame = CreateComponent<GameEngineUIRenderer>(EUI_RENDERORDERORDER::Frame);
	...
	m_BiologyPageComposition.Illustration = CreateComponent<GameEngineUIRenderer>(EUI_RENDERORDERORDER::Component);
