...
void ContentsCore::LoadContentsData()
{
	...
	ItemData::CreateData("SilverStarFlower_Water", { "SilverStarFlower_Water", "¿∫∫∞πÊøÔ≤…¡Û", EITEM_TYPE::Ingredient });
	ItemData::CreateData("MoonButterfly_Water", { "MoonButterfly_Water", "¥ﬁ∫˚ ≥™∫Ò ¡Û", EITEM_TYPE::Ingredient });


	ItemData::CreateData("Mongsiri_Collect", { "Mongsiri_Collect", "∏˘Ω√∏Æ≈–", EITEM_TYPE::Ingredient });
	ItemData::CreateData("BushBug_Collect", { "BushBug_Collect", "π˙∑π", EITEM_TYPE::Ingredient });
	ItemData::CreateData("WitchFlower_Collect", { "WitchFlower_Collect", "∏∂≥‡¿« ≤…", EITEM_TYPE::Ingredient });
	ItemData::CreateData("FlowerBird_Collect", { "FlowerBird_Collect", "≤…ªı¿« ≤…", EITEM_TYPE::Ingredient });
	ItemData::CreateData("MapleHerb_Collect", { "MapleHerb_Collect", "∏ﬁ¿Ã«√ «„∫Í", EITEM_TYPE::Ingredient });
	ItemData::CreateData("SilverStarFlower_Collect", { "SilverStarFlower_Collect", "¿∫∫∞πÊøÔ≤… ∞°∑Á", EITEM_TYPE::Ingredient });
	ItemData::CreateData("MoonButterfly_Collect", { "MoonButterfly_Collect", "¥ﬁ∫˚ ≥™∫Ò", EITEM_TYPE::Ingredient });


	ItemData::CreateData("Item_Etc_10", { "Item_Etc_10", "¬¯¡Û±‚ ¿Ø∏Æ∫¥", EITEM_TYPE::Quest });

	// ∆˜º«
	ItemData::CreateData("BadGrassPotion", { "BadGrassPotion", "≥™ª€ «Æ ¡¶∞≈π∞æ‡", EITEM_TYPE::Potion });
	ItemData::CreateData("NutritionPotion", { "NutritionPotion", "øµæÁ ∞¯±ﬁ π∞æ‡", EITEM_TYPE::Potion });
	ItemData::CreateData("FirecrackerPotion", { "FirecrackerPotion", "∫“≤…≥Ó¿Ã π∞æ‡", EITEM_TYPE::Potion });

	ItemData::CreateData("UncurseCandy", { "UncurseCandy", "¿˙¡÷«ÿ¡¶ ªÁ≈¡", EITEM_TYPE::Potion });
	ItemData::CreateData("HealingCandy", { "HealingCandy", "»∏∫π ªÁ≈¡", EITEM_TYPE::Potion });
