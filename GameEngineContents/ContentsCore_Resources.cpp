...
void ContentsCore::LoadContentsData()
{
	...
	// µµ±¸
	ItemData::CreateData("Item_Etc_11", { "Item_Etc_11", "ÀáÀÚ¸®Ã¤", EITEM_TYPE::Tool });
	ItemData::CreateData("Item_Etc_12", { "Item_Etc_12", "ºøÀÚ·ç", EITEM_TYPE::Tool });
	...
	ProductRecipeData::CreateData("FirecrackerPotion", { std::vector<ProductRecipeData::MaterialInfo>{{"SilverStarFlower_Water", 1,}, { "FlowerBird_Water", 1 },{"BushBug_Water", 1} }, EBREWING_DIFFICULTY::Hard, EBREWING_DIRECTION::StirLeft, EBREWING_FIRE::Two, "FirecrackerPotion", "ÆøÁ× ¹°¾à" , {} });

	// »çÅÁ
	/*std::vector<ProduectDESC> UncurseCandyDESCArray = { {EPRODUCTDESCTYPE::Observation, "¸¶³à°¡ ¹«¾ð°¡ ¸¸µé ¶§ ¸¹ÀÌ »ç¿ëÇÏ±â ¶§¹®¿¡, ¸¶³à ²ÉÀÌ¶ó´Â ÀÌ¸§ÀÌ ºÙ¿©Á³´Ù."},{EPRODUCTDESCTYPE::, "¸¶³à°¡ ¹«¾ð°¡ ¸¸µé ¶§ ¸¹ÀÌ »ç¿ëÇÏ±â ¶§¹®¿¡, ¸¶³à ²ÉÀÌ¶ó´Â ÀÌ¸§ÀÌ ºÙ¿©Á³´Ù."} };*/
	...
	QuestData::CreateData("FindLetter", { "FindLetter" , "ÆíÁö ÀÐ±â", "¸¶´ç¿¡ ÀÖ´Â ÆíÁö¸¦ ÀÐ¾îº¸ÀÚ." });
}
